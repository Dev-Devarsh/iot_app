...
class _smokeState extends State<smoke> {
  ...
  Future getData() async {
    var resp = await http.get(Uri.parse(
        'https://intiotpro.000webhostapp.com/API/fetch_smokesenser.php'));
    setState(() {
      List respJson = json.decode(resp.body)["smoke"];
      setState(() {
        name = respJson;
        isLoading = false;
      });
                      ...
                      child: Row(children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Smoke Value : ${name[index]['smoke_value']}",
                              style: TextStyle(fontWeight: FontWeight.w400),
                            ),
                          ],
                        ),
