...
class Ldr extends StatefulWidget {
  const Ldr({Key? key}) : super(key: key);
...
class _LdrState extends State<Ldr> {
  ...
  Future getData() async {
    var resp = await http.get(
        Uri.parse('https://intiotpro.000webhostapp.com/API/fetch_ldr.php'));
    setState(() {
      List respJson = json.decode(resp.body)["ldr"];
      setState(() {
        name = respJson;
        isLoading = false;
      });
                      ...
                      child: Row(children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Light Source value: ${name[index]['ldr_value']}",
