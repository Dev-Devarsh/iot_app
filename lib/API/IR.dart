...
class _IrState extends State<Ir> {
  ...
  Future getData() async {
    var resp = await http
        .get(Uri.parse('https://intiotpro.000webhostapp.com/API/fetch_ir.php'));
    setState(() {
      List respJson = json.decode(resp.body)["ir"];
      setState(() {
        name = respJson;
        isLoading = false;
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Infrared Sensors Data'),
